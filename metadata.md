...
<div class="metadata">
   ...
   <dl class="grid">
      <dt>Name:</dt>
      <dd>Groundtruth ULB VD18 ODEM</dd>
      <dt>Description:</dt>
      <dd>Groundtruth ULB VD18 ODEM</dd>
      <dt>Language:</dt>
      <dd>deu</dd>
...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/tboenig/ulb-groundtruth-eval-odem-ger/releases/tag/v1.0.14">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 16_v1.0.14</a>
      </li>
      <li>
